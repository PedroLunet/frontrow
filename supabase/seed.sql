...
VALUES
  ...
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'TV Girl', '44444444-4444-4444-4444-444444444444', '2026-09-10 19:30:00+00', 'Somos todos traficantes cada um tem a sua aprte eu sou o gajo que lea ganza para gaia todas as tarde eu queria que me beefassem mas sao todos uns covarde, tu achas que és o jack harlow mas tropa tu es o ze carlos. o isak ficou soft ja nao sou como era dantes, o vitor deu o mix e o master em ganda blunt, no meu colo tenho uma bitch que tem as mamas bueda grandes a minha glock tem um switch eu chamo le mia fernandes. E eu confesso, chorei quando o svate saiu da quinta, fumei crack, fiquei high, peguei na navalha meti na cinta, uns pintaram me de meu entao eu roubei lhes a tinta, armando teles apanhado a vender bolota na vinted', 'TV Girl Summer Tour', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJZJMDFH9tWJ6GpX1ekTBKbjIZRa9ZosQALg&s', now(), now()),
